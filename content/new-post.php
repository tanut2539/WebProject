			...
			<fieldset class="form-group">
				<div class="col-md col-md-12">
					<div class="input-group">
						...
						<input name="forum-title" type="text" class="form-control" placeholder="Subject" aria-describedby="basic-addon1">
					</div>
				</div>
			</fieldset>
		</header>
			...
			<div class="form-group">
				<div class="col-md col-md-12">
				  ...
				  <label for="exampleInputEmail1">Topics Feeds</label>
					<textarea name="text-feeds" class="form-control" placeholder="Details"  rows="5"></textarea>
					 </div>
				</div>
				</div>
		</div>
			...
			<div class="form-group">
				<div class="col-md col-md-12">
				  ...
				  <label for="exampleInputEmail1">Details All</label>
					<textarea name="text-details" class="form-control" placeholder="Details"  rows="10"></textarea>
					 </div>
					 <div class="form-group">
						<button name="new-post" type="submit" class="btn btn-primary">Post</button>
					</div>
				</div>
				</div>
		</div>
